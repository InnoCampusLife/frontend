...
/***/ function(module, exports) {
	...
	module.exports = "\n<div block=\"\" _v-4b8f5ba4=\"\">\n\t<h1 _v-4b8f5ba4=\"\">Registered users</h1>\n\n\t<p v-if=\"$loadingRouteData\" _v-4b8f5ba4=\"\">Loading users…</p>\n\n\t<ul _v-4b8f5ba4=\"\">\n\t\t<li v-for=\"user in users\" _v-4b8f5ba4=\"\">\n\t\t\t<user :user=\"user\" :role-changed=\"roleChanged\" _v-4b8f5ba4=\"\"></user>\n\t\t</li>\n\t</ul>\n\n\t<button padding=\"\" style=\"border-width: 0px;width: 100%;height: 30px;\" id=\"acceptRoles\" v-show=\"roleChanged\" @click=\"sendRoles\" @keyup.enter=\"sendRoles\" _v-4b8f5ba4=\"\">accept changes</button>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		components: {
			application: __webpack_require__(56)
		},
		methods: {
...
/***/ function(module, exports) {
	...
	module.exports = "\n\n\n\n<div card=\"\" class=\"card\" _v-05beb5e6=\"\">\n\t<form id=\"ip_request\" _v-05beb5e6=\"\">\n\t\t<h1 _v-05beb5e6=\"\">New Application</h1>\n\n\t\t<hr _v-05beb5e6=\"\">\n\n\t\t<p v-show=\"!$loadingRouteData\" _v-05beb5e6=\"\">Loading…</p>\n\t\t\n\t\t<div v-show=\"!!$loadingRouteData\" class=\"grid-12_xs-1\" _v-05beb5e6=\"\">\n\t\t\t<div class=\"col-4\" _v-05beb5e6=\"\">\n\t\t\t\t<label for=\"activity_category\" _v-05beb5e6=\"\">Category</label>\n\t\t\t</div>\n\t\t\t<div class=\"col-8\" _v-05beb5e6=\"\">\n\t\t\t\t<select id=\"activity_category\" v-model=\"current.category_id\" @change=\"category_changed\" _v-05beb5e6=\"\">\n\t\t\t\t\t<option value=\"\" selected=\"\" _v-05beb5e6=\"\">Select Category</option>\n\t\t\t\t\t<option value=\"\" _v-05beb5e6=\"\">All</option>\n\t\t\t\t\t<option v-for=\"category in categories\" value=\"{{category.id}}\" _v-05beb5e6=\"\">{{ category.title }}</option>\n\t\t\t\t</select>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<hr _v-05beb5e6=\"\">\n\n\t\t<div _v-05beb5e6=\"\">\n\t\t\t<h2 _v-05beb5e6=\"\">Participants</h2>\n\t\t\t<!-- <button type=\"button\" @click=\"current_users_count_inc\">+</button> -->\n\t\t\t<!-- <button type=\"button\" @click=\"current_users_count_dec\" \n\t\t\t\t\tv-show=\"current.users.length > 1\">-</button> -->\n\t\t\t<div v-for=\"i of current.users.length\" _v-05beb5e6=\"\">\n\t\t\t\t<!-- <p>{{i}} : {{current.users.length}}</p> -->\n\t\t\t\t\n\t\t\t\t<div _v-05beb5e6=\"\">\n\t\t\t\t\t\t<input data-index=\"{{ i }}\" type=\"text\" placeholder=\"username\" @input=\"username_changed\" value=\"{{i ? '' : user.account.username}}\" _v-05beb5e6=\"\">\n\t\t\t\t</div>\n\t\t\t\t\n\t\t\t\t<!-- Check is category is selected: v-show=\"!categorySelected\" -->\n\n\t\t\t\t\t<div _v-05beb5e6=\"\">\n\t\t\t\t\t\t<label for=\"activity\" _v-05beb5e6=\"\">Activity</label>\n\t\t\t\t\t\t<select id=\"activity\" class=\"activity\" v-model=\"current.users[i].activity_id\" @change=\"activity_changed\" _v-05beb5e6=\"\">\n\t\t\t\t\t\t\t<option value=\"\" selected=\"\" _v-05beb5e6=\"\">Choose Activity</option>\n\t\t\t\t\t\t\t<option v-for=\"activity in activities\" value=\"{{activity.id}}\" _v-05beb5e6=\"\">{{ activity.title }}</option>\n\t\t\t\t\t\t</select>\n\t\t\t\t\t</div>\n\t\t\t\t\t\n\t\t\t\t\t<div v-show=\"!showAmount(current.users[i].activity_id)\" _v-05beb5e6=\"\">\n\t\t\t\t\t\t<label for=\"amount\" _v-05beb5e6=\"\">Time spent/quantity:</label>\n\t\t\t\t\t\t\t<input id=\"amount\" type=\"number\" class=\"amount\" min=\"1\" max=\"365\" value=\"0\" v-model=\"current.users[i].amount\" _v-05beb5e6=\"\">\n\t\t\t\t\t</div>\n\n\t\t\t</div>\n\t\t\t\n\t\t</div>\n\n\t\t<hr _v-05beb5e6=\"\">\n\n\t\t<div _v-05beb5e6=\"\">\n\t\t\t<label _v-05beb5e6=\"\">\n\t\t\t\tAttached files:\n\t\t\t\t<input block=\"\" type=\"file\" id=\"upload\" @change=\"uploaded\" multiple=\"\" _v-05beb5e6=\"\">\n\t\t\t</label>\n\t\t</div> \n\t\t<textarea style=\"max-width: 100%; min-width: 100%; transition: height 0s\" id=\"comment\" placeholder=\"Comment here...\" v-model=\"current.comment\" _v-05beb5e6=\"\"></textarea>\n\n\t\t<pre v-if=\"!categorySelected\" _v-05beb5e6=\"\">Select Category!</pre>\n\t\t<pre v-if=\"categorySelected &amp;&amp; !activitySelected\" _v-05beb5e6=\"\">Fill in the rest!</pre>\n\t\t<button v-if=\"activitySelected\" block=\"\" type=\"button\" @click=\"accept\" id=\"accept\" _v-05beb5e6=\"\">accept</button>\n\t</form>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		components: {
			content: __webpack_require__(25)
		}
	};
	// </script>
