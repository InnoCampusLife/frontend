...
/***/ function(module, exports, __webpack_require__) {
	...
	requireAllIn = function requireAllIn(directory) {
	    __webpack_require__(76).context(directory, true, /^.*(\.js|\.vue)$/);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./storage": 8,
		"./storage.js": 8,
		"./styles/colors/aqua.css": 77,
		"./styles/colors/dodger-blue.css": 79,
		"./styles/colors/gray.css": 81,
		"./styles/colors/green.css": 83,
		"./styles/colors/orange.css": 85,
		"./styles/colors/red.css": 87,
		"./styles/content.css": 89,
		"./styles/helpers.css": 90,
		"./styles/main.less": 68,
		"./styles/sidebar.css": 91,
		"./styles/store.css": 92,
		"./styles/transitions.css": 93,
		"./views/accounts/admin.vue": 38,
		"./views/accounts/main.vue": 35,
		"./views/accounts/user.vue": 94,
		"./views/app.vue": 4,
		"./views/content.vue": 20,
		"./views/header.vue": 22,
		"./views/innopoints/application.vue": 50,
		"./views/innopoints/applications.vue": 48,
		"./views/innopoints/apply.vue": 54,
		"./views/innopoints/main.vue": 45,
		"./views/login.vue": 11,
		"./views/main.vue": 14,
		"./views/profile/main.vue": 29,
		"./views/profile/profile.vue": 32,
		"./views/sidebar.vue": 16,
		"./views/store/cart.vue": 97,
		"./views/store/cartItem.vue": 99,
		"./views/store/item.vue": 64,
		"./views/store/main.vue": 59,
		"./views/store/store.vue": 62,
		"./views/test.vue": 26
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\views\\store\\cart.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\views\\store\\cartItem.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-9cc72f8e/cartItem.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
